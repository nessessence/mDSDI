...
green_domain = [maroon3, dimgray, darkolivegreen, deeppink, darkslateblue, darkcyan, yellowgreen, darkblue, purple2, darkseagreen]
...
red_domain = [dodgerblue, khaki, lightgreen, saddlebrown, mediumslateblue, violet, lightpink, lightsteelblue, blue, deepskyblue]
