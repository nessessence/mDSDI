from algorithms.DSDI_SemiSupervised.src.models import resnet_ae
from algorithms.DSDI_SemiSupervised.src.models import resnet
from algorithms.DSDI_SemiSupervised.src.models import mnistnet
