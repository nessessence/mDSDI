from algorithms.ERM.src.dataloaders.PACS_Dataloader import PACSDataloader, PACS_Test_Dataloader
from algorithms.ERM.src.dataloaders.MNIST_Dataloader import MNISTDataloader, MNIST_Test_Dataloader
from algorithms.ERM.src.dataloaders.MNIST_AUG_Dataloader import MNISTAUGDataloader, MNIST_AUG_Test_Dataloader
from algorithms.ERM.src.dataloaders.Colored_MNIST_Dataloader import ColoredMNISTDataloader, Colored_MNIST_Test_Dataloader
from algorithms.ERM.src.dataloaders.FMNIST_Dataloader import FMNISTDataloader, FMNIST_Test_Dataloader
from algorithms.ERM.src.dataloaders.FMNIST_AUG_Dataloader import FMNISTAUGDataloader, FMNIST_AUG_Test_Dataloader
from algorithms.ERM.src.dataloaders.DomainNet_Dataloader import DomainNetDataloader, DomainNet_Test_Dataloader
from algorithms.ERM.src.dataloaders.OfficeHome_Dataloader import OfficeHomeDataloader, OfficeHome_Test_Dataloader
