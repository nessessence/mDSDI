...
class Trainer_DI_AE:
    def __init__(self, args, device, exp_idx):
        ...
        optimizer = list(self.model.parameters()) + list(self.classifier.parameters()) + list(self.domain_discriminator.parameters())
    ...
    def train(self):
        ...
        for iteration in range(self.args.iterations):
            ...
            total_loss = classification_loss + 0.5 * predicted_domain_di_loss + 0.5 * reconstruction_loss
